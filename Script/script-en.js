...
const ver = document.querySelector('#vermais-en');
const vertext = document.querySelector('#vertext-en');
...
function verm() {
  var ver = document.getElementById('vermais-en')
  ...
  var vertext = document.getElementById('vertext-en')
  var arrowup = document.getElementById('arrowup')
  var arrowdown = document.getElementById('arrowdown')
  var sm = document.getElementById('sobremim')


  vertext.innerText = 'HIDE'
